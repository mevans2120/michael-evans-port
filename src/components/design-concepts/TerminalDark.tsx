...
const TerminalNavigationCard: React.FC<NavigationCardProps> = ({ title, description, targetSection, onNavigate }) => {
  return (
    <motion.button
...
const TerminalMessage: React.FC<MessageProps> = ({ content, isUser, navigationCards = [] }) => {
  return (
    <div className="mb-6">
    ...
    <div className="h-screen w-screen bg-neutral-950 overflow-hidden font-mono">
      ...
      >
        ...
        >
          ...
          {panelState !== 'expanded' && (
            <div className="[writing-mode:vertical-rl] text-xs font-bold tracking-wider">
              ASSISTANT
            </div>
          )}
