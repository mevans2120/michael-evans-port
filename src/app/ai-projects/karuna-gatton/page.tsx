...
export default function KarunaGattonPage() {
  const { data: project, loading, error } = useAIProject('karuna-gatton');
      ...
      <main id="main-content" role="main" className="pt-32 pb-12 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="animate-fade-in">
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 mb-8">
              <h2 className="text-2xl font-medium mb-4">Technical Architecture</h2>
              ...
              <div>
                <h3 className="font-medium text-foreground mb-4">AI Components</h3>
            ...
            {/* Key Learnings */}
            <div className="bg-secondary/30 rounded-2xl p-8 mb-8">
              <h2 className="text-2xl font-medium mb-4">Key Learnings</h2>
